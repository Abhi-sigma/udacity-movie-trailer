...
# initializing different instances of movies that I want to use in the traler movie website
...
# creating a list of instances of movies which is passed to  function open_movies_pages in fresh_tomtoes.py script
# 
